...
extern uint8_t volatile g_yemian_num;           // 当前所在的页面，默认上电进入页面一，1-页面一（电机点动调试），2-页面二（逆运动学控制）
extern uint16_t volatile g_moveplate_x;                  // 动平台绕着竖直轴旋转角度，初始化为0
extern uint16_t volatile g_moveplate_y;                  // 动平台绕着水平轴旋转角度，初始化位0
/*----------------------------------声明全局变量----------------------------*/
